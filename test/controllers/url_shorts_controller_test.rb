...
class UrlShortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create url_short" do
    assert_difference('UrlShort.count') do
      post url_shorts_url, params: { url_short: { original_url: @url_short.original_url, short_url: @url_short.short_url } }
    end
  ...
  test "should update url_short" do
    patch url_short_url(@url_short), params: { url_short: { original_url: @url_short.original_url, short_url: @url_short.short_url } }
